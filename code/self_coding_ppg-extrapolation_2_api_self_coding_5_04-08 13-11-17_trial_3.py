...
def inspection(input_data, output_data, sampling_rate=None):
    ...
    # 1) Check if the output_data has values within a reasonable range
    ...
    # If none of the invalidation conditions triggered, output data is valid
    return True
...
def challenger(input_data, output_data, sampling_rate=None):
    ...
    # If both checks are within acceptable limits, prediction is assumed faithful
    return True
